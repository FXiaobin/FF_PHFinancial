...
#define kMainColor          kHexColor(0x37afff)
///透明色
#define kClearColor         [UIColor clearColor]
#define kWhiteColor         [UIColor whiteColor]
#define kTitleColor         kHexColor(0x333333)
#define kContentColor       kHexColor(0x666666)
#define kTimeColor          kHexColor(0x999999)
#define kSepreatorColor     kHexColor(0xf6f6f6)
#define kPlaceholderColor   kHexColor(0xcccccc)
...
extern NSString * const  LoginSuccessfulNotification;
